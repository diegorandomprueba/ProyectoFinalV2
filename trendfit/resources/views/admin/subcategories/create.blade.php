...
@section('title', 'Crear Subcategoría - Trendfit Admin')

@section('header', 'Crear Subcategoría')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="p-6">
            <h2 class="text-2xl font-semibold mb-6">Crear Nueva Subcategoría</h2>
                ...
                <div class="mb-6">
                    ...
                    <select id="idCategoria" name="idCategoria" class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500 @error('idCategoria') border-red-500 @enderror" required>
                        ...
                        @foreach($categories as $category)
                            <option value="{{ $category->id }}" {{ old('idCategoria') == $category->id ? 'selected' : '' }}>
                                {{ $category->name }}
                            </option>
                        @endforeach
                    </select>
